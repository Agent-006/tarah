    ...
    const fetchPost = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `/api/admin/blog/posts/${(params as any).id}`
        );
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 text-lg">
                Update and manage your blog content with advanced controls
              </p>
            </div>
              ...
              <div className="lg:col-span-2 space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Update your blog post content with our advanced editor
                    </CardDescription>
                  </CardHeader>
                    ...
                    >
                      ...
                      <TabsContent value="media" className="space-y-6 mt-6">
                        <div className="space-y-4">
                          ...
                          <p className="text-gray-600">
                            Update cover image and social media preview image
                          </p>
                        </div>
